 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.HyperLinkImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HyperLinkImpl extends TextImpl implements HyperLink {
	...
	protected EClass eStaticClass() {
		return PSMDocxPackage.Literals.HYPER_LINK;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.HYPER_LINK__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PSMDocxPackage.HYPER_LINK__URL:
				return getUrl();
		}
