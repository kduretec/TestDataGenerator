 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.TextImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TextImpl extends MinimalEObjectImpl.Container implements Text {
	...
	protected EClass eStaticClass() {
		return PSMDocxPackage.Literals.TEXT;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.TEXT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PSMDocxPackage.TEXT__VALUE:
				return getValue();
		}
