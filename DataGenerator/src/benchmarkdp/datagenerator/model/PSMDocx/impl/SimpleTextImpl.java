 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.SimpleTextImpl#getFontFamily <em>Font Family</em>}</li>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.SimpleTextImpl#getSize <em>Size</em>}</li>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.SimpleTextImpl#getColor <em>Color</em>}</li>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.SimpleTextImpl#getBackground <em>Background</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimpleTextImpl extends TextImpl implements SimpleText {
	...
	protected EClass eStaticClass() {
		return PSMDocxPackage.Literals.SIMPLE_TEXT;
	}
	...
	public void setFontFamily(FontFamily newFontFamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.SIMPLE_TEXT__FONT_FAMILY, oldFontFamily, fontFamily));
	}
	...
	public void setSize(int newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.SIMPLE_TEXT__SIZE, oldSize, size));
	}
	...
	public void setColor(Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.SIMPLE_TEXT__COLOR, oldColor, color));
	}
	...
	public void setBackground(Color newBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.SIMPLE_TEXT__BACKGROUND, oldBackground, background));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PSMDocxPackage.SIMPLE_TEXT__FONT_FAMILY:
				return getFontFamily();
			case PSMDocxPackage.SIMPLE_TEXT__SIZE:
				return getSize();
			case PSMDocxPackage.SIMPLE_TEXT__COLOR:
				return getColor();
			case PSMDocxPackage.SIMPLE_TEXT__BACKGROUND:
