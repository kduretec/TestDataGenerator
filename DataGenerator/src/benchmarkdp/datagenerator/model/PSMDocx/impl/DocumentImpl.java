 ...
 *   <li>{@link benchmarkdp.datagenerator.model.PSMDocx.impl.DocumentImpl#isCalcLayout <em>Calc Layout</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentImpl extends MinimalEObjectImpl.Container implements Document {
	...
	public void setCalcLayout(boolean newCalcLayout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMDocxPackage.DOCUMENT__CALC_LAYOUT, oldCalcLayout, calcLayout));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PSMDocxPackage.DOCUMENT__CALC_LAYOUT:
				return isCalcLayout();
		}
