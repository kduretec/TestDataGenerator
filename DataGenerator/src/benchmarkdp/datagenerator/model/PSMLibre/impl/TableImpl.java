 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMLibre.impl.TableImpl#getNumRows <em>Num Rows</em>}</li>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMLibre.impl.TableImpl#getNumCol <em>Num Col</em>}</li>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMLibre.impl.TableImpl#getRow <em>Row</em>}</li>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMLibre.impl.TableImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends TextContainerImpl implements Table {
	...
	protected EClass eStaticClass() {
		return PSMLibrePackage.Literals.TABLE;
	}
	...
	public void setNumRows(int newNumRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMLibrePackage.TABLE__NUM_ROWS, oldNumRows, numRows));
	}
	...
	public void setNumCol(int newNumCol) {
		...
		numCol = newNumCol;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMLibrePackage.TABLE__NUM_COL, oldNumCol, numCol));
	}
	...
	public void setType(TableType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PSMLibrePackage.TABLE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PSMLibrePackage.TABLE__NUM_ROWS:
				return getNumRows();
			case PSMLibrePackage.TABLE__NUM_COL:
				return getNumCol();
			case PSMLibrePackage.TABLE__ROW:
				return getRow();
			case PSMLibrePackage.TABLE__TYPE:
				return getType();
		}
