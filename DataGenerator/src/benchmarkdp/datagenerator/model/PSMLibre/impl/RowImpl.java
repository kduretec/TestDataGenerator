 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.datagenerator.model.PSMLibre.impl.RowImpl#getCell <em>Cell</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowImpl extends MinimalEObjectImpl.Container implements Row {
	...
	protected EClass eStaticClass() {
		return PSMLibrePackage.Literals.ROW;
	}
	...
	public EList<Cell> getCell() {
		if (cell == null) {
			cell = new EObjectContainmentEList<Cell>(Cell.class, this, PSMLibrePackage.ROW__CELL);
		}
		return cell;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PSMLibrePackage.ROW__CELL:
