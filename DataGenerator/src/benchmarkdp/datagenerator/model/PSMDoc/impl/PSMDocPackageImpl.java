...
import benchmarkdp.datagenerator.model.PSMDoc.FontFamily;
import benchmarkdp.datagenerator.model.PSMDoc.HyperLink;
import benchmarkdp.datagenerator.model.PSMDoc.Image;
import benchmarkdp.datagenerator.model.PSMDoc.PSMDocFactory;
...
import benchmarkdp.datagenerator.model.PSMDoc.TextContainer;
 ...
 * @generated
 */
public class PSMDocPackageImpl extends EPackageImpl implements PSMDocPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see benchmarkdp.datagenerator.model.PSMDoc.PSMDocPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PSMDocPackageImpl() {
		super(eNS_URI, PSMDocFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link PSMDocPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PSMDocPackage init() {
		if (isInited) return (PSMDocPackage)EPackage.Registry.INSTANCE.getEPackage(PSMDocPackage.eNS_URI);

		// Obtain or create and register package
		PSMDocPackageImpl thePSMDocPackage = (PSMDocPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PSMDocPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PSMDocPackageImpl());

		isInited = true;

		// Create package meta-data objects
		thePSMDocPackage.createPackageContents();

		// Initialize created meta-data
		thePSMDocPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thePSMDocPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PSMDocPackage.eNS_URI, thePSMDocPackage);
		return thePSMDocPackage;
	}
	 ...
	 * @generated
	 */
	public PSMDocFactory getPSMDocFactory() {
		return (PSMDocFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSimpleText_Size(), ecorePackage.getEInt(), "size", null, 0, 1, SimpleText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSimpleText_Background(), this.getColor(), "background", null, 0, 1, SimpleText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
