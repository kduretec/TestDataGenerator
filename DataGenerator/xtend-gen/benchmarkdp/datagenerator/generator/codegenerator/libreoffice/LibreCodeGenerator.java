...
import benchmarkdp.datagenerator.generator.codegenerator.libreoffice.LibreCode;
...
public class LibreCodeGenerator implements CodeGeneratorInterface {
  ...
  public void generateCode(final TestCase tC) {
    ...
    this.libreCode.platform = _documentPlatform;
    String _helper = this.helper();
    this.libreCode.addHelperFunction(_helper);
