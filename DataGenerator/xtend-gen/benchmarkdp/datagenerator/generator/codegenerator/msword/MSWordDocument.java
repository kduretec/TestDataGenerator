...
public class MSWordDocument extends AbstractElementCompiler {
  ...
  public void compile(final EObject object, final CompilerState cState) {
    ...
    _builder_1.append("\t\t");
    _builder_1.newLine();
    _builder_1.append("objFileMetadata.Write \"pagecount \" & oDoc.ComputeStatistics(2) & vbCrLf");
    _builder_1.newLine();
    _builder_1.append("objFileMetadata.Write \"wordcount \" & oDoc.ComputeStatistics(0) & vbCrLf");
    _builder_1.newLine();
    _builder_1.append("objFileMetadata.Write \"paragraphcount \" & oDoc.ComputeStatistics(4)");
    _builder_1.newLine();
    _builder_1.append("oDoc.Saved = TRUE");
    _builder_1.newLine();
    _builder_1.append("objFile.Close()");
    _builder_1.newLine();
    _builder_1.append("objFileMetadata.Close()");
    _builder_1.newLine();
