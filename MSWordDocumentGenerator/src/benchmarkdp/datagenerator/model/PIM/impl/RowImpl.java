 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.datagenerator.model.PIM.impl.RowImpl#getCell <em>Cell</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowImpl extends MinimalEObjectImpl.Container implements Row {
	...
	protected EClass eStaticClass() {
		return PIMPackage.Literals.ROW;
	}
	...
	public EList<Cell> getCell() {
		if (cell == null) {
			cell = new EObjectContainmentEList<Cell>(Cell.class, this, PIMPackage.ROW__CELL);
		}
		return cell;
	}
