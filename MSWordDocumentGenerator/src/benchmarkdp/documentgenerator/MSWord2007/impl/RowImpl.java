 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.RowImpl#getCell <em>Cell</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowImpl extends MinimalEObjectImpl.Container implements Row {
	...
	protected EClass eStaticClass() {
		return MSWordPackage.Literals.ROW;
	}
	...
	public EList<Cell> getCell() {
		if (cell == null) {
			cell = new EObjectContainmentEList<Cell>(Cell.class, this, MSWordPackage.ROW__CELL);
		}
		return cell;
	}
