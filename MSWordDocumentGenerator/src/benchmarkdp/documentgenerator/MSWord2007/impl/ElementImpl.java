 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.ElementImpl#getAlignment <em>Alignment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	protected EClass eStaticClass() {
		return MSWordPackage.Literals.ELEMENT;
	}
	...
	public void setAlignment(String newAlignment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MSWordPackage.ELEMENT__ALIGNMENT, oldAlignment, alignment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MSWordPackage.ELEMENT__ALIGNMENT:
				return getAlignment();
		}
