 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.HyperlinkImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HyperlinkImpl extends TextImpl implements Hyperlink {
	...
	protected EClass eStaticClass() {
		return MSWordPackage.Literals.HYPERLINK;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MSWordPackage.HYPERLINK__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MSWordPackage.HYPERLINK__URL:
				return getUrl();
		}
