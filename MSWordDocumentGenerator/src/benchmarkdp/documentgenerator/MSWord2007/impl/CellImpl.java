 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.CellImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellImpl extends MinimalEObjectImpl.Container implements Cell {
	...
	protected EClass eStaticClass() {
		return MSWordPackage.Literals.CELL;
	}
	...
	public EList<Element> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<Element>(Element.class, this, MSWordPackage.CELL__ELEMENT);
		}
		return element;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MSWordPackage.CELL__ELEMENT:
