 ...
 * </p>
 * <ul>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.ParagraphImpl#getParagraphSpacing <em>Paragraph Spacing</em>}</li>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.ParagraphImpl#getLineSpacing <em>Line Spacing</em>}</li>
 *   <li>{@link benchmarkdp.documentgenerator.MSWord2007.impl.ParagraphImpl#getIndent <em>Indent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends TextContainerImpl implements Paragraph {
	...
	protected EClass eStaticClass() {
		return MSWordPackage.Literals.PARAGRAPH;
	}
	...
	public void setParagraphSpacing(double newParagraphSpacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MSWordPackage.PARAGRAPH__PARAGRAPH_SPACING, oldParagraphSpacing, paragraphSpacing));
	}
	...
	public void setLineSpacing(double newLineSpacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MSWordPackage.PARAGRAPH__LINE_SPACING, oldLineSpacing, lineSpacing));
	}
	...
	public void setIndent(double newIndent) {
		...
		indent = newIndent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MSWordPackage.PARAGRAPH__INDENT, oldIndent, indent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MSWordPackage.PARAGRAPH__PARAGRAPH_SPACING:
				return getParagraphSpacing();
			case MSWordPackage.PARAGRAPH__LINE_SPACING:
				return getLineSpacing();
			case MSWordPackage.PARAGRAPH__INDENT:
				return getIndent();
		}
